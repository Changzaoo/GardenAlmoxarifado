...
const WorkPontoTab = () => {
  ...
  const [testSuccess, setTestSuccess] = useState(null); // { similarity: string }
  ...
  const capturarPonto = async () => {
    ...
    try {
      ...
      // Se for modo teste, apenas mostrar sucesso e parar
      if (tipoPonto === 'teste') {
        setError(null);
        setMatching(false);
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Testar Reconhecimento Facial - Após cadastrar foto */}
      {hasReferencePhoto && (
