...
const InputMensagem = ({ 
  ...
  return (
    <div className="border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-4">
      ...
      {arquivoSelecionado && (
        <div className="mb-3 flex items-center gap-3 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
      ...
      <div className="flex items-end gap-2">
        ...
        <div className="relative">
          ...
          {/* Menu de anexos */}
          {showAttachMenu && (
            <div className="absolute bottom-full left-0 mb-2 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 p-2 min-w-[150px]">
              <button
        ...
        <div className="flex-1 bg-gray-100 dark:bg-gray-700 rounded-2xl px-4 py-2">
          <textarea
            ...
            disabled={disabled}
            className="w-full bg-transparent border-none outline-none resize-none max-h-32 text-gray-900 dark:text-gray-100 placeholder-gray-500 disabled:opacity-50"
            rows={1}
          />
