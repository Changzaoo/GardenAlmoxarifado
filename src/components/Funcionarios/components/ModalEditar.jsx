      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl max-w-md w-full mx-4 p-6 border border-gray-200 dark:border-gray-600">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <select
              value={formEdit.cargo || 'outro'}
              onChange={e => {
                const value = e.target.value;
                if (value === 'outro') {
                  setFormEdit({ ...formEdit, cargo: '', cargoPersonalizado: true });
                } else {
                  setFormEdit({ ...formEdit, cargo: value, cargoPersonalizado: false });
                }
              }}
              className="w-full px-4 py-2 rounded-lg text-sm bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-[#1D9BF0]"
            >
            ...
            {formEdit.cargoPersonalizado && (
              <input
                type="text"
                placeholder="Digite o cargo personalizado..."
                value={formEdit.cargo}
                onChange={e => setFormEdit({ ...formEdit, cargo: e.target.value })}
                className="w-full px-4 py-2 rounded-lg text-sm bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-[#1D9BF0] mt-2"
                autoFocus
              />
            )}
          </div>
